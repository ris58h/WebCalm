...
object CssPropertyLookupElements {
    ...
    val PROPERTY_VALUES_LOOKUP_ELEMENTS = mapOf(
        ...
        "caption-side" to listOf(),
        "caret-color" to listOf(),
        "clear" to listOf(),
        "clip" to listOf(),
        "clip-path" to listOf(),
        "color" to listOf(),
        "column-count" to listOf(),
        "column-fill" to listOf(),
        "column-gap" to listOf(),
        "column-rule" to listOf(),
        "column-rule-color" to listOf(),
        "column-rule-style" to listOf(),
        "column-rule-width" to listOf(),
        "column-span" to listOf(),
        "column-width" to listOf(),
        "columns" to listOf(),
        "content" to listOf(),
        "counter-increment" to listOf(),
        "counter-reset" to listOf(),
        "cursor" to listOf(),
        "direction" to listOf(),
        "display" to listOf(
            "inline",
